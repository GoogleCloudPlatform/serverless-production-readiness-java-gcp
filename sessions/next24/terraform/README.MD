...
## Issues & TODOs
## CI to build the images and push to artifact registry..GCE instance need external ip to install psql & download sql with ddl & Cloud run need to allow unauthenticated