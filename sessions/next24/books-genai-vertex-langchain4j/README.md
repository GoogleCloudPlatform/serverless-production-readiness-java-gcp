...
gcloud storage buckets add-iam-policy-binding gs://${BUCKET_BOOKS_PUBLIC} --member=allUsers --role=roles/storage.objectViewer
...
gcloud storage buckets add-iam-policy-binding gs://${BUCKET_BOOKS_PRIVATE} --member=allUsers --role=roles/storage.objectViewer
...
gcloud storage buckets add-iam-policy-binding gs://${BUCKET_BOOKS_SUMMARY} --member=allUsers --role=roles/storage.objectViewer
```
